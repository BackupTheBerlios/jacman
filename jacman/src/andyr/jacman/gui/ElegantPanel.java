...
public class ElegantPanel extends JPanel {
	...
	public void doLayout() {
		...
		mainPanel.setBounds(insets.left + 3, insets.top + TITLE_HEIGHT + 3,
				w - 6, h - TITLE_HEIGHT);

	}

	/*
	 * public Dockable getDockable() { if(dockable==null) dockable = new
	 * DockableImpl(this, getTitleLabel()); return dockable; }
	 */
	...
	public void paintComponent(Graphics g) {
		...
		GradientPaint firstHalf = new GradientPaint(in.left, y, GRAD_START,
				mid, y, GRAD_MID);
		GradientPaint secondHalf = new GradientPaint(mid, y, GRAD_MID,
				farRight, y, getBackground());
		...
		g.drawLine(in.left, in.top + TITLE_HEIGHT, farRight, in.top
				+ TITLE_HEIGHT);
	}
